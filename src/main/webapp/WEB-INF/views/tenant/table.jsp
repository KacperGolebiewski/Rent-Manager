                                ...
                                <div class="table-responsive p-0">
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="align-middle text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                                <spring:message code="tenant.description.text"/>
                                            </th>
                                            <th class="align-middle text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                        ...
                                        <c:forEach items="${tenants}" var="tenant">
                                            ...
                                            <c:if test="${tenant.property.id==property.id}">
                                            <tr>
                                                <td>
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="text-xs font-weight-bold mb-0">${tenant.tenancyStartDate}</p>
                                                    <p class="text-xs font-weight-bold mb-0">${tenant.tenancyEndDate}</p>
                                                </td>
                                                ...
                                                <td class="align-middle text-center">
                                                        <a class="align-middle btn btn-link text-danger text-gradient px-3 mb-0" href="<c:url value="/tenant/confirm-delete/${tenant.id}"/>"><i class="align-middle material-icons text-sm me-2">delete</i><spring:message code="delete.text"/></a>
                                                        <a class="align-middle btn btn-link text-dark px-3 mb-0" href="<c:url value="/tenant/edit/${tenant.id}"/>"><i class="align-middle material-icons text-sm me-2">edit</i><spring:message code="edit.text"/></a>
                                                </td>
                                            </tr>
                                            </c:if>
                                            </c:forEach>
