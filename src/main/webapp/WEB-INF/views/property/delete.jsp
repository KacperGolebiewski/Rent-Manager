                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <a class="align-middle btn btn-link text-danger text-gradient px-3 mb-0" href="<c:url value="/property/delete/${property.id}"/>"><spring:message code="confirm.text"/></a>
                                                    <a class="align-middle btn btn-link text-dark px-3 mb-0" href="/user/property"><spring:message code="return.text"/></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
