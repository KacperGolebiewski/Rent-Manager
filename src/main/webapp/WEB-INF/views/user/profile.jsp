        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><spring:message code="navbar.my.profile.text"/></li>
                </ol>
                <h6 class="font-weight-bolder mb-0"><spring:message code="navbar.my.profile.text"/></h6>
            </nav>
                ...
                <div class="col-lg-2 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " href="<c:url value="/user/edit/${user.id}"/>">
                                    <i class="fas fa-user-edit text-secondary text-sm" title="Edit Profile"></i>
                                    <span class="ms-1"><spring:message code="form.editProfile.text"/></span>
                                </a>
                            </li>
                        </ul>
                    </div>
